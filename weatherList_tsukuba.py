...
# スマホの画面幅に完全特化させる設定
st.set_page_config(page_title="つくば市の天気比較", layout="centered")
...
st.title("🌲 つくば市 ３社天気予報")

# --- 1. tenki.jp のスクレイピング関数 ---
def get_tenki_jp_week():
    url = "https://tenki.jp/forecast/3/11/4020/8220/10days.html"
...
def get_yahoo_weather_week():
    url = "https://weather.yahoo.co.jp/weather/8/4020/8220.html"
    headers = {"User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64)"}
...
def get_weathernews_week():
    url = "https://weathernews.jp/onebox/tenki/ibaraki/08220/week.html?tab=4"
    headers = {"User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64)"}
